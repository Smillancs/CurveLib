...
void gVertexBuffer::DrawIndexed(GLenum _mode, GLint _first, GLsizei _count, const GLvoid* _indices)
{
	glDrawElements(_mode, _count, GL_UNSIGNED_INT, (unsigned int*)(_indices)+_first);
}
